    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <article>
                ...
                <header class="mb-4">
                    ...
                    <!-- Post meta content-->
                    <div class="text-muted fst-italic mb-2">Posted on {{ $post->created_at }} by {{ $post->user->name }}
                    </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body"> <a class="btn btn-Secondary" href="{{ route('posts.edit',$post->id) }}">Edit This Post</a>
                </div>
            </div>
        </div>
    </div>
